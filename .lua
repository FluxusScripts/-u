if IY_LOADED and not _G.IY_DEBUG == true then
	...
	-- error("Infinite Yield is already running!",0)	return
...
local apfo_t = {"Ricky Wicky Yield 😱", "Infinite Bread", "Egg Admino", "Amity coughed", "Where am I", "Rickity Yieldd", "walter white", "Nick Cage?!?!", "peyton real", "april fool!!"}
...
if os.date("%m %d") == "04 01" then
	...
	Title.Text = apfo_t[math.random(1, #apfo_t)] .. " v" .. currentVersion
...
if os.date("%m %d") == "04 01" then
	...
	Logo.Image = "rbxassetid://" .. apfo_i[math.random(1, #apfo_i)]
		...
		if pcall(function() readfile("IY_FE.iy") end) then
			...
			if readfile("IY_FE.iy") ~= nil then
				...
				local success, response = pcall(function()
					...
					if json.currentShade3 ~= nil then currentShade3 = Color3.new(json.currentShade3[1],json.currentShade3[2]
